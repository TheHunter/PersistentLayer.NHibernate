...
namespace PersistentLayer.NHibernate.Test.DAL
{
        ...
        : CurrentTester
    {
        ...
        public void FailedMakePersistentSave2Test()
        {
            ...
            SessionProvider.BeginTransaction(IsolationLevel.ReadCommitted);
            Salesman cons = CurrentRootPagedDAO.ExecuteExpression<Salesman, Salesman>(saleswoman => saleswoman.First());
        ...
        {
            this.CurrentRootPagedDAO.ExecuteExpression<Salesman, Salesman>(null);
        }
        ...
        public void TestExecutesuspiciousExpression()
        {
            ...
            this.CurrentRootPagedDAO.ExecuteExpression<Salesman, IEnumerable<Salesman>>
                (
